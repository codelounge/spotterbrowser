...
class Controller_Website extends Controller_Template {
	...
	public function before()
	{
		...
		$this->template = CL_View::factory($this->template, array(), 'default');
		
		$theme = Kohana::config('spotterbrowser.desktoptheme');
		...
		if ($this->auto_render) {
			...
			$this->template->styles = array(
					...
					'media/css/ui-darkness/jquery-ui-1.8.7.custom.css' => 'screen',
				);
