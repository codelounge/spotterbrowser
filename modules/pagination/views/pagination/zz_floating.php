...
<p class="pagination">
	...
	<?php else: ?>
		<span class="pagingelement_no_link"><?php echo __('First') ?></span>
	<?php endif ?>

	<?php if ($previous_page !== FALSE): ?>
		<a href="<?php echo $page->url($previous_page) ?>" rel="prev"><?php echo __('Previous') ?></a>
	<?php else: ?>
		<span class="pagingelement_no_link"><?php echo __('Previous') ?></span>
	<?php endif ?>

	<?php foreach ($links as $number => $content): ?>

		<?php if ($number === $current_page): ?>
			<span class="pagingelement_active"><?php echo $content ?></span>
		<?php else: ?>
	...
	<?php else: ?>
		<span class="pagingelement_no_link"><?php echo __('Next') ?></span>
	<?php endif ?>

	<?php if ($last_page !== FALSE): ?>
		<a href="<?php echo $page->url($last_page) ?>" rel="last"><?php echo __('Last') ?></a>
	<?php else: ?>
		<span class="pagingelement_no_link"><?php echo __('Last') ?></span>
	<?php endif ?>
